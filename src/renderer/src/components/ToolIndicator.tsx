  ...
  return (
    <div className="flex flex-col gap-2 mt-2">
      {toolCalls.map((call, idx) => {
        ...
        const displayArgs = argString.length > 100 ? argString.slice(0, 100) + '...' : argString;

        return (
          <div
            key={callId}
            className="flex flex-col p-2 text-xs rounded-md bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 max-w-full overflow-hidden"
          >
            <div 
            ...
            >
                ...
                <div className="flex-1 min-w-0 overflow-hidden">
                    ...
                    {!isExpanded && (
                        <div className="text-[11px] text-gray-500 dark:text-gray-400 font-mono truncate mt-0.5 max-w-xs md:max-w-sm lg:max-w-md">
                        Args: {displayArgs}
                        </div>
                    )}
                </div>
            ...
            {isExpanded && (
                <div className="mt-2 pl-10 pr-2 pb-1 overflow-hidden space-y-3 max-w-full">
                    <div className="max-w-full overflow-hidden">
                        <div className="text-[10px] font-mono text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">Arguments</div>
                        <pre className="text-[11px] font-mono bg-gray-50 dark:bg-gray-900 p-2 rounded border border-gray-200 dark:border-gray-700 whitespace-pre-wrap break-all max-w-full overflow-x-auto">
                    ...
                    {call.result && (
                        <div className="max-w-full overflow-hidden">
                            ...
                            <pre className="text-[11px] font-mono bg-emerald-50/50 dark:bg-emerald-900/10 p-2 rounded border border-emerald-100 dark:border-emerald-900/30 whitespace-pre-wrap break-all text-gray-700 dark:text-gray-300 max-w-full overflow-x-auto">
