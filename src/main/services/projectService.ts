...
export const projectService = {
    async getActiveProjectMeta(): Promise<ProjectMeta> {
        return { name: 'SignalZero Desktop', version: '1.1.6', created_at: '', updated_at: '', author: 'klietus' };
    },
    ...
    async import(buffer: Buffer): Promise<{ stats: ProjectImportStats, systemPrompt?: string, mcpPrompt?: string }> {
        try {
            ...
            let meta: ProjectMeta = { name: 'Imported', version: '1.1.6', created_at: '', updated_at: '', author: '' };
